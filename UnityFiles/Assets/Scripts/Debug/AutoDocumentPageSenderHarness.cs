...
public class AutoDocumentPageSenderHarness : MonoBehaviour
{
    ...
    [SerializeField] private bool logEmulatedJsonMessages = true;
    ...
    public void CloseSession()
    {
        ...
        DispatchJsonToDocumentManager(root.ToString(Newtonsoft.Json.Formatting.None), "WEB-EMULATED-OUT");
    ...
    public void SendPageByZeroBasedIndex(int zeroBasedPage)
    {
        ...
        for (var i = 0; i < chunks.Length; i++)
        {
            ...
            DispatchJsonToDocumentManager(pageRoot.ToString(Newtonsoft.Json.Formatting.None), "WEB-EMULATED-OUT");
        }
    ...
    private void DispatchJsonToDocumentManager(string json, string lane)
    {
        if (logEmulatedJsonMessages)
            Debug.Log($"[AutoDocumentPageSenderHarness][{lane}] {json}");
