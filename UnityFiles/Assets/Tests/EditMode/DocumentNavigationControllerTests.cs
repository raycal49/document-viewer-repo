...
public class DocumentNavigationControllerTests
{
    ...
    {
        _documentManager.HandleMessage("{\"type\":\"document-start\",\"documentId\":\"doc-123\",\"documentName\":\"Manual\",\"totalPages\":4}");
    ...
    public void InboundNavigateMessage_IsAppliedByController()
    {
        ...
        _navigationChannel.TryHandleInboundMessage("{\"type\":\"document-navigate\",\"documentId\":\"doc-123\",\"pageIndex\":99,\"source\":\"remote\"}");
    ...
    public void InboundRequestPage_DoesNotRebroadcast()
    {
        ...
        _navigationChannel.TryHandleInboundMessage("{\"type\":\"document-request-page\",\"documentId\":\"doc-123\",\"pageIndex\":2}");
